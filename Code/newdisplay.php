...
<div id="content">
  <?php
    while ($row = mysqli_fetch_array($result)) {
      echo "<div id='img_div'>";
        echo "<img src='images2/".$row['image']."' >";
        echo "<p>".$row['image_text']."</p>";
      echo "</div>";
    }
  ?>
  <form method="POST" action="newdisplay.php" enctype="multipart/form-data">
...
<form class= "my-form" action="profile.php"   >

      <input class="button" type="submit" value= "Return to your profile" name= "" >
      <br><br><br><br>
